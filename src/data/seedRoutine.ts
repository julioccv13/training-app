...
const fiveDayStrengthRoutine: Routine = {
  id: 'routine-five-day-strength',
  name: '5 Day Strength',
  description: 'Split de 5 dias con enfasis en fuerza para los movimientos principales y accesorios en rango hipertrofia.',
  createdAt: SEED_TIMESTAMP,
  updatedAt: SEED_TIMESTAMP,
  isArchived: false,
}
...
const fiveDayStrengthDayTemplates: Array<Omit<RoutineDay, 'routineId'>> = [
  { id: 'strength-day-1', name: 'Dia 1', focus: 'Posterior pierna / gluteo', order: 1 },
  { id: 'strength-day-2', name: 'Dia 2', focus: 'Pecho / triceps / abdomen', order: 2 },
  { id: 'strength-day-3', name: 'Dia 3', focus: 'Hombro / brazos / antebrazo', order: 3 },
  { id: 'strength-day-4', name: 'Dia 4', focus: 'Cuadriceps / gluteo', order: 4 },
  { id: 'strength-day-5', name: 'Dia 5', focus: 'Espalda / core', order: 5 },
]

const fiveDayStrengthExerciseTemplates: Array<Omit<RoutineExercise, 'routineId'>> = [
  {
    id: 'strength-ex-deadlift',
    dayId: 'strength-day-1',
    slug: 'peso-muerto-strength',
    name: 'Peso muerto',
    muscleGroup: 'Posterior cadena',
    targetSets: 5,
    targetReps: '6-8 / 5 / 4',
    targetWeight: 0,
    restSeconds: 150,
    notes: 'Deja la quinta serie opcional si ese dia solo haras 4 series de trabajo.',
    order: 1,
  },
  {
    id: 'strength-ex-hip-thrust',
    dayId: 'strength-day-1',
    slug: 'hip-thrust-strength',
    name: 'Hip thrust',
    muscleGroup: 'Gluteos',
    targetSets: 3,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Aprieta gluteos arriba y evita perder la pelvis.',
    order: 2,
  },
  {
    id: 'strength-ex-lying-leg-curl',
    dayId: 'strength-day-1',
    slug: 'curl-acostado-strength',
    name: 'Curl acostado',
    ...
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Haz la bajada controlada y evita despegar la cadera.',
    order: 3,
  },
  {
    id: 'strength-ex-single-leg-curl',
    dayId: 'strength-day-1',
    slug: 'curl-femoral-individual',
    name: 'Curl femoral individual',
    muscleGroup: 'Isquiotibiales',
    targetSets: 3,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Controla la fase de bajada y evita rotar la cadera.',
    order: 4,
  },
  {
    id: 'strength-ex-abductors-day-1',
    dayId: 'strength-day-1',
    slug: 'abductores-dia-1',
    name: 'Abductores maquina o elasticos',
    muscleGroup: 'Gluteo medio',
    targetSets: 3,
    targetReps: '12-20',
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Ajusta la variante segun el equipo disponible.',
    order: 5,
  },
  {
    id: 'strength-ex-calf-day-1',
    dayId: 'strength-day-1',
    slug: 'pantorrilla-dia-1',
    name: 'Pantorrilla',
    muscleGroup: 'Gemelos',
    targetSets: 3,
    targetReps: '12-20',
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Usa rango completo con una pausa breve arriba.',
    order: 6,
  },
  {
    id: 'strength-ex-flat-bench-press',
    dayId: 'strength-day-2',
    slug: 'press-plano-strength',
    name: 'Press plano',
    muscleGroup: 'Pecho',
    targetSets: 5,
    targetReps: '6-8 / 5 / 4',
  ...
  {
    id: 'strength-ex-incline-press',
    dayId: 'strength-day-2',
    slug: 'press-inclinado-strength',
    ...
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Mantiene el hombro estable durante toda la serie.',
    order: 2,
  },
  {
    id: 'strength-ex-dips',
    dayId: 'strength-day-2',
    slug: 'paralelas-strength',
    name: 'Paralelas',
    ...
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Usa asistencia o lastre segun el objetivo del dia.',
    order: 3,
  },
  {
    id: 'strength-ex-incline-fly',
    dayId: 'strength-day-2',
    slug: 'aperturas-inclinado-strength',
    name: 'Aperturas inclinado',
    muscleGroup: 'Pecho',
    targetSets: 3,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Mantiene un estiramiento controlado sin perder tension.',
    order: 4,
  },
  {
    id: 'strength-ex-crossover-flyes',
    dayId: 'strength-day-2',
    slug: 'crossover-o-flyes-strength',
    name: 'Crossover o flyes con poleas o elasticos',
    muscleGroup: 'Pecho',
    targetSets: 3,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Escoge la variante que te deje cerrar fuerte sin dolor de hombro.',
    order: 5,
  },
  {
    id: 'strength-ex-abs-day-2',
    dayId: 'strength-day-2',
    slug: 'abdomen-dia-2',
    name: 'Abdomen',
    muscleGroup: 'Core',
    ...
    targetWeight: 0,
    restSeconds: 45,
    notes: 'Elige la variante que mejor puedas progresar semana a semana.',
    order: 6,
  },
  {
    id: 'strength-ex-overhead-press',
    dayId: 'strength-day-3',
    slug: 'press-militar-strength',
    name: 'Press militar',
    muscleGroup: 'Hombro',
    targetSets: 5,
    targetReps: '6-8 / 5 / 4',
  ...
  {
    id: 'strength-ex-lateral-raise',
    dayId: 'strength-day-3',
    slug: 'abduccion-hombros-strength',
    name: 'Abduccion hombros',
    muscleGroup: 'Deltoides lateral',
    targetSets: 3,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Sube con control sin convertirlo en un balanceo.',
    order: 2,
  },
  {
    id: 'strength-ex-face-pull',
    dayId: 'strength-day-3',
    slug: 'face-pull-strength',
    name: 'Face pull',
    ...
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Termina con rotacion externa y buena retraccion escapular.',
    order: 3,
  },
  {
    id: 'strength-ex-barbell-curl',
    dayId: 'strength-day-3',
    slug: 'curl-barra-strength',
    name: 'Curl barra',
    muscleGroup: 'Biceps',
    targetSets: 4,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Evita empujar con la cadera para completar las reps.',
    order: 4,
  },
  {
    id: 'strength-ex-neutral-dumbbell-curl',
    dayId: 'strength-day-3',
    slug: 'curl-neutro-mancuerna-strength',
    name: 'Curl neutro mancuerna',
    muscleGroup: 'Braquial / braquiorradial',
    targetSets: 4,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Mantiene la muñeca neutra durante todo el recorrido.',
    order: 5,
  },
  {
    id: 'strength-ex-french-press',
    dayId: 'strength-day-3',
    slug: 'press-frances-strength',
    name: 'Press frances',
    muscleGroup: 'Triceps',
    targetSets: 4,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Controla la bajada y evita abrir demasiado los codos.',
    order: 6,
  },
  {
    id: 'strength-ex-rope-pushdown',
    dayId: 'strength-day-3',
    slug: 'pushdown-lazo-strength',
    name: 'Pushdown lazo',
    muscleGroup: 'Triceps',
    targetSets: 4,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 75,
    notes: 'Separa la cuerda al final para completar la extension.',
    order: 7,
  },
  {
    id: 'strength-ex-wrist-curl',
    dayId: 'strength-day-3',
    slug: 'wrist-curl-strength',
    name: 'Wrist curl',
    ...
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Recorrido corto, continuo y sin soltar la tension.',
    order: 8,
  },
  {
    id: 'strength-ex-reverse-wrist-curl',
    dayId: 'strength-day-3',
    slug: 'reverse-wrist-curl-strength',
    ...
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Busca bombeo y control, no rango incompleto.',
    order: 9,
  },
  {
    id: 'strength-ex-squat',
    dayId: 'strength-day-4',
    slug: 'sentadilla-strength',
    name: 'Sentadilla',
  ...
  {
    id: 'strength-ex-belt-squat',
    dayId: 'strength-day-4',
    slug: 'belt-squat-strength',
    name: 'Belt squat',
    ...
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Mantiene el torso estable y busca profundidad consistente.',
    order: 2,
  },
  {
    id: 'strength-ex-leg-extension',
    dayId: 'strength-day-4',
    slug: 'extensiones-strength',
    name: 'Extensiones',
    muscleGroup: 'Cuadriceps',
    targetSets: 3,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Aprieta arriba sin despegar la cadera del respaldo.',
    order: 3,
  },
  {
    id: 'strength-ex-alternating-lunges',
    dayId: 'strength-day-4',
    slug: 'zancadas-alternando-strength',
    name: 'Zancadas alternando',
    muscleGroup: 'Cuadriceps / gluteos',
    targetSets: 3,
    targetReps: '8-12',
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Da un paso estable y manten el control de la rodilla.',
    order: 4,
  },
  {
    id: 'strength-ex-sissy-squat',
    dayId: 'strength-day-4',
    slug: 'sentadilla-sissy-strength',
    ...
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Controla la profundidad y usa apoyo si lo necesitas.',
    order: 5,
  },
  {
    id: 'strength-ex-calf-day-4',
    dayId: 'strength-day-4',
    slug: 'pantorrilla-dia-4',
    name: 'Pantorrilla',
    muscleGroup: 'Gemelos',
    targetSets: 3,
    targetReps: '12-20',
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Pausa un instante en el pico de contraccion.',
    order: 6,
  },
  {
    id: 'strength-ex-abductors-day-4',
    dayId: 'strength-day-4',
    slug: 'abductores-maquina-dia-4',
    name: 'Abductores maquina',
    muscleGroup: 'Gluteo medio',
    targetSets: 3,
    targetReps: '12-20',
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Busca control y rango antes de subir carga.',
    order: 7,
  },
  {
    id: 'strength-ex-barbell-row',
    dayId: 'strength-day-5',
    slug: 'remo-barra-strength',
    name: 'Remo barra',
  ...
  {
    id: 'strength-ex-pullups-pulldown',
    dayId: 'strength-day-5',
    slug: 'dominadas-jalones-maquina',
    name: 'Dominadas o jalones en maquina',
    muscleGroup: 'Dorsales',
    targetSets: 3,
    targetReps: '6-12',
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Escoge la variante que mejor puedas cargar sin perder rango.',
    order: 2,
  },
  {
    id: 'strength-ex-row-variation',
    dayId: 'strength-day-5',
    slug: 'remo-agarre-bajo-o-pecho-apoyado',
    name: 'Remo agarre bajo o remo con pecho apoyado',
    muscleGroup: 'Espalda',
    targetSets: 3,
    targetReps: '6-12',
    targetWeight: 0,
    restSeconds: 90,
    notes: 'Busca recorrido escapular completo en el remo.',
    order: 3,
  },
  {
    id: 'strength-ex-pullover',
    dayId: 'strength-day-5',
    slug: 'pullover-strength',
    name: 'Pullover',
    muscleGroup: 'Dorsales',
    targetSets: 3,
    targetReps: '6-12',
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Mantiene el pecho alto y no conviertas el gesto en press.',
    order: 4,
  },
  {
    id: 'strength-ex-core-lumbar',
    dayId: 'strength-day-5',
    slug: 'abdomen-lumbar-dia-5',
    name: 'Abdomen o lumbar',
    muscleGroup: 'Core / lumbar',
    targetSets: 3,
    targetReps: '10-15 o 30-45 seg',
    targetWeight: 0,
    restSeconds: 60,
    notes: 'Hiperextensiones, plancha o rodillo funcionan bien segun el equipo.',
    order: 5,
  },
]
...
const upperLowerRoutineExerciseTemplates: Array<Omit<RoutineExercise, 'routineId'>> = [
  {
    id: 'ul-ex-incline-chest-press', dayId: 'ul-day-upper', slug: 'ul-incline-chest-press', name: 'Press inclinado de pecho',
    muscleGroup: 'Pecho superior', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 90,
    notes: 'Manten el hombro estable durante toda la serie.', order: 1,
  },
  {
    id: 'ul-ex-pec-deck-fly', dayId: 'ul-day-upper', slug: 'ul-pec-deck-fly', name: 'Aperturas de pecho (Pec Deck)',
    muscleGroup: 'Pecho', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 75,
    notes: 'Controla el estiramiento y aprieta en el cierre.', order: 2,
  },
  {
    ...
    notes: 'Recorrido completo sin bloquear en exceso arriba.', order: 3,
  },
  {
    id: 'ul-ex-preacher-curl', dayId: 'ul-day-upper', slug: 'ul-preacher-curl', name: 'Curl de biceps (predicador)',
    muscleGroup: 'Biceps', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 75,
    notes: 'Controla la bajada y no despegues los codos del apoyo.', order: 4,
  },
  {
  ...
  {
    id: 'ul-ex-leg-press', dayId: 'ul-day-lower', slug: 'ul-leg-press', name: 'Press de pierna (Prensa)',
    muscleGroup: 'Cuadriceps', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 90,
    notes: 'Sin despegar la lumbar del respaldo.', order: 1,
  },
  {
    id: 'ul-ex-single-leg-extension', dayId: 'ul-day-lower', slug: 'ul-single-leg-extension', name: 'Extension de pierna',
    muscleGroup: 'Cuadriceps', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 60,
    notes: 'Pausa arriba y baja con control.', order: 2,
  },
  {
    id: 'ul-ex-seated-leg-curl', dayId: 'ul-day-lower', slug: 'ul-seated-leg-curl', name: 'Curl de pierna (femoral sentado)',
    muscleGroup: 'Isquiotibiales', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 75,
    notes: 'Baja controlado sin despegar la cadera.', order: 3,
  },
  {
    id: 'ul-ex-romanian-deadlift', dayId: 'ul-day-lower', slug: 'ul-romanian-deadlift', name: 'Peso muerto rumano',
    muscleGroup: 'Isquiotibiales / gluteo', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 120,
    notes: 'Bisagra de cadera con espalda neutra y controla el descenso.', order: 4,
  },
  {
    id: 'ul-ex-calf-raise', dayId: 'ul-day-lower', slug: 'ul-calf-raise', name: 'Elevacion de pantorrilla',
    muscleGroup: 'Gemelos', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 60,
    notes: 'Rango completo con pausa breve en el pico.', order: 5,
  },
  {
    id: 'ul-ex-crunch-maquina-lower', dayId: 'ul-day-lower', slug: 'ul-crunch-maquina-lower', name: 'Abdomen (crunch en maquina)',
    muscleGroup: 'Core', targetSets: 3, targetReps: '5-10', targetWeight: 0, restSeconds: 45,
    notes: 'Flexiona la columna con control, sin tirar del cuello.', order: 6,
  },
]
...
const builtInRoutineSeeds = [
  {
    ...
    days: workoutTrackerSeedDays,
    exercises: workoutTrackerSeedExercises,
  },
  {
...
export const seedRoutineBundle: RoutineBundle = {
  routines: [defaultRoutine, ...builtInRoutineSeeds.map((item) => item.routine)],
  days: [...seedDays, ...builtInRoutineSeeds.flatMap((item) => item.days)],
  exercises: [...seedExercises, ...builtInRoutineSeeds.flatMap((item) => item.exercises)],
}
...
const ensureBuiltInRoutines = (bundle: RoutineBundle): RoutineBundle => {
  return builtInRoutineSeeds.reduce((currentBundle, seed) => {
    const hasRoutine = currentBundle.routines.some((routine) => routine.id === seed.routine.id)
    if (hasRoutine) {
      return currentBundle
    }

    return {
      routines: [...currentBundle.routines, seed.routine],
      days: [...currentBundle.days, ...seed.days],
      exercises: [...currentBundle.exercises, ...seed.exercises],
    }
  }, bundle)
}
